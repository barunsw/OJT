...
public class SqlSessionTest {
	...
	public static void main(String[] args) throws Exception {
		...
		try (SqlSession session = fac.openSession()) { // sqlSession이 crud 관련 메서드를 제공, openSession에 보면 autocommit에 대한 파라미터를 boolean값으로 줄 수 있는데 강제로 true를 통해 동작하는게 맞는지 질문 
			...
			session.delete("com.barunsw.ojt.cjs.day05.PersonDao.deletePerson", 106);
...
//			return 값이 int형임
			...
			mapper.deletePerson(112); //delete 변경된 row갯수 리턴
