...
public class SqlSessionFactoryManager {
	...
	static {
		String resource = "SqlMapConfig.xml"; // mybatis 설정 파일의 경로
		Reader reader = null;
		...
		sqlSessionFactory = new SqlSessionFactoryBuilder().build(reader, "development", System.getProperties()); // reader로부터
																													// 설정을
																													// 읽고,
																													// development라는
																													// 환경을
