...
import com.barunsw.ojt.sjcha.day11.AddressVo;
import com.barunsw.ojt.sjcha.day11.TestFrame;
import com.barunsw.ojt.sjcha.day11.TestPanel;
...
public class TestPanel extends JPanel {
	...
	public void init() {
		try {
			addressBookInterface = new SocketAddressBookImpl("localhost", ServerMain.PORT);
		}
		catch (Exception ex) {
	...
	private void updateData() {
		...
		try {
			...
			/*
			 * Object value = tableModel.getValueAt(selectedRow, COLUMN_INDEX_PERSON); if
			 * (value instanceof AddressVo) { try { AddressVo addressVo = (AddressVo)value;
			 * addressBookInterface.updateAddress(addressVo); } catch (Exception ex) {
			 * LOGGER.error(ex.getMessage(), ex); } }
			 */
