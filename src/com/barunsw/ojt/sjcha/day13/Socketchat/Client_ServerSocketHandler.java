...
public class Client_ServerSocketHandler extends Thread {
	private static final Logger LOGGER = LogManager.getLogger(Client_ServerSocketHandler.class);

	private Socket socket;

	private ServerInterface serverImpl;

	public Client_ServerSocketHandler(Socket socket, ServerInterface serverImpl) {
		this.socket = socket;
	...
	public int handRegister(String userName) throws Exception {
		int registerResult = serverImpl.register(userName, new Server_ClientWriteImpl(socket));
