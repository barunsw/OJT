...
public class TestPanel extends JPanel {
	...
	private void doSomething() {
		Thread doSomethingThread = new Thread(new Runnable() {
			public void run() {
				LOGGER.debug(String.format("start activeCount[%d]",Thread.activeCount()));
				...
				LOGGER.debug(String.format("finish activeCount[%d]",Thread.activeCount()));
			}
		});
	...
	/*final Runnable doSomethings = new Runnable() {
		public void run() {
			LOGGER.debug(String.format("start activeCount[%d]",Thread.activeCount()));
