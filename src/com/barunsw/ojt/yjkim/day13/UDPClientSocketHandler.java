...
public class UDPClientSocketHandler extends Thread{
	private static final Logger LOGGER = LogManager.getLogger(UDPClientSocketHandler.class);
	...
	InetAddress ia;
	public UDPClientSocketHandler(DatagramSocket clientSocket) {
		LOGGER.debug("+++ UDPClientSocketHandler");
			...
			while (true) {
				...
				switch (cmd) {
					...
					case "INSERT":
						...
						UDPhandleInsert(addressVo);
						break;
					case "UPDATE":
						addressVo = parseCmd(cmdSplit[1]);
						UDPhandleUpdate(addressVo);
						break;
					case "DELETE":
						addressVo = parseCmd(cmdSplit[1]);
						UDPhandleDelete(addressVo);
						break;
	...
	private void UDPhandleInsert(AddressVo addressVo) {
	...
	private void UDPhandleUpdate(AddressVo addressVo) {
	...
	private void UDPhandleDelete(AddressVo addressVo) {
	...
	private void UDPhandleAllSelect() throws Exception {
